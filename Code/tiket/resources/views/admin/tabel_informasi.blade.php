        ...
        <div class="container-fluid">
            ...
            <div class="container">
                <div class="d-sm-flex align-items-center justify-content-between mb-4">
                    <h1 class="h3 mb-0 text-gray-800">Informasi KBT</h1>
                </div>
                ...
                <table border="1">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                @if($data->image)
                                <img src="{{ asset($data->image) }}" alt="Gambar" style="width: 100px; height: auto;">
                                @else
                                Tidak ada gambar
                                @endif
                            </td>
                            <td class="action-buttons">
                                <div class="d-flex justify-content-center align-items-center" style="height: 100%;">
                                    <!-- Tombol Edit -->
                                    <a href="{{ route('admin.edit_informasi', $data->id) }}" class="btn btn-primary" style="margin-bottom: 20px;">
                                        <i class="bi bi-pencil-fill"></i>
                                    </a>

                                    <!-- Tombol Delete -->
                                    <form action="{{ route('admin.informasi.destroy', $data->id) }}" method="POST" style="margin-left: 10px;">
                                        @csrf
                                        @method('DELETE')
