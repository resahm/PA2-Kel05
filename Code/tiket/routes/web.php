...
Route::middleware(['auth:admin'])->group(function () {
    ...
    Route::post('/admin/informasi/{id}/update', [InformasiController::class, 'update'])->name('admin.informasi.update');
    Route::post('/admin/informasi/{id}/delete', [InformasiController::class, 'destroy'])->name('admin.informasi.destroy');
    Route::get('/admin/tabel_informasi', [InformasiController::class, 'tabelInformasi'])->name('admin.tabel_informasi');
    Route::get('/admin/informasi/{id}/edit', [InformasiController::class, 'edit'])->name('admin.edit_informasi');
