    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="nav nav-tabs nav-tabs-bordered d-flex" id="borderedTabJustified" role="tablist">
                ...
                <li class="nav-item flex-fill" role="presentation">
                    <a class="nav-link w-100 ajax-link {{ request()->is('users/cek_pesanan') ? 'active' : '' }}" href="{{ route('users.cek_pesanan') }}" id="contact-tab" role="tab" aria-controls="cek pesanan" aria-selected="false">CEK PESANAN</a>
                </li>
                <li class="nav-item flex-fill" role="presentation">
                    <a class="nav-link w-100 ajax-link {{ request()->is('users/history') ? 'active' : '' }}" href="{{ route('users.history') }}" id="contact-tab" role="tab" aria-controls="history" aria-selected="false">HISTORY</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link fs-8 ajax-link {{ request()->is('users/barang') ? 'active' : '' }}" href="{{ route('users.barang') }}"><img src="{{ url('assets/img/barang.jpg') }}" alt="" style="height: 60px;">KIRIM BARANG</a>
                </li>
