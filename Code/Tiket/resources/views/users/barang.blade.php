    ...
    <main id="main" class="main">
        ...
        <div class="container-fluid">
            ...
            <div class="container">
                ...
                <form action="{{ route('users.paket.store') }}" method="POST">
                    @csrf
                    ...
                    <input type="number" id="id_pengirim" name="id_pengirim" required>
                    <br>

                    <label for="id_penerima">ID Penerima</label>
                    <input type="number" id="id_penerima" name="id_penerima" required>
                    <br>
                ...
                <script>
                    ...
                    document.getElementById('waktu_kedatangan').min = new Date().toISOString().split('T')[0];
                    document.getElementById('waktu_keberangkatan').min = new Date().toISOString().split('T')[0];
                </script>
