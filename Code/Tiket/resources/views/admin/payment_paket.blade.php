    ...
    <main id="main" class="main">
        ...
        <div class="container-fluid">
            ...
            <div class="container">
                ...
                @if(isset($imageUrl))
                <p>Image uploaded successfully: <a href="{{ asset($imageUrl) }}">{{ $imageUrl }}</a></p>
                @endif
                ...
                <table>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                @if($detail->image)
                                <img src="{{ asset($detail->image) }}" alt="Bukti Pembayaran">
                                @else
                                Tidak ada gambar
                                @endif
                            </td>
                        ...
                        @else
                        <tr>
                            <td colspan="6">Tidak ada data pembayaran Paket tersedia</td>
                        </tr>
                        @endif
                    </tbody>
                </table>
