                ...
                <div class="col-lg-8">
                    <div class="row">
                            ...
                            <div class="card info-card customers-card">
                                <div class="card-body">
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="ps-3">
                                            <h6>{{$jumlah_pelanggan = DB::table('tickets')->distinct()->count('id');}}</h6>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    <h5 class="card-title">Graphic Rating Ulasan</h5>
                        ...
                        <div class="col-12">
                            <div class="card recent-sales overflow-auto">
                                <div class="card-body">
                                    <h5 class="card-title">Ulasan Pelanggan</h5>
                                    ...
                                    <table class="table table-borderless datatable">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <th scope="row"><a href="#">{{ $ulasan->id }}</a></th>
                                                <td>{{ $ulasan->email }}</td>
                                                <td>{{ $ulasan->review }}</td>
                                                <td>{{ $ulasan->rating }}</td>
